...
export const TRANSLATIONS = {
  ...
  AR: {
    ...
    ui: {
      searchPlaceholder: "ابحث في لبلاد...",
      heroTitle: "بيع واشتري بـ",
      heroTitleHighlight: "كل ثقة",
      heroSubtitle: "المنصة المثالية لجميع احتياجاتك في الجزائر.",
      currencyTitle: "بورصة الجزائر",
      eventsTitle: "أحداث قريبة",
      filtersTitle: "تصفية",
      ...
      category: "الفئة",
      clearAll: "مسح الكل",
      commonFilters: "فلاتر شائعة",
      viewProfile: "مشاهدة الملف",
      viewAd: "مشاهدة الإعلان",
